 ...
 *
 *
 * @param mavenOutputLines is a List of String, where each String is a line of the Maven's build process's output
 * @param mavenizedProjectFolder is a String
 * @param assignment identifies the [Assignment] that Submission targetted.
 * @param junitResults is a List of [JunitResults] with the result of evaluating the Submission using JUnit tests
 * @param jacocoResults is a List of [JacocoResults] with the result of evaluating the Submission's code coverage
 * @apram assignmentTestMethods is a List of [AssignmentTestMethod]. Each object describes on of the executed Unit Tests
 */
